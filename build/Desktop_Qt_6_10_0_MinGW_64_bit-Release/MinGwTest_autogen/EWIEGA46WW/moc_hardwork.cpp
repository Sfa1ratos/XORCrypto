...
void HardWork::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->InitPrBar((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 4: _t->wInitPrBar((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 5: _t->filePrBarValue((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 6: _t->prBarValue((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 7: _t->wFilePrBarValue((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 8: _t->wPrBarValue((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 9: _t->message((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 10: _t->Working(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        if (QtMocHelpers::indexOfMethod<void (HardWork::*)()>(_a, &HardWork::timerStart, 1))
            return;
        if (QtMocHelpers::indexOfMethod<void (HardWork::*)()>(_a, &HardWork::finished, 2))
            return;
        if (QtMocHelpers::indexOfMethod<void (HardWork::*)(int )>(_a, &HardWork::InitPrBar, 3))
            return;
        if (QtMocHelpers::indexOfMethod<void (HardWork::*)(int )>(_a, &HardWork::wInitPrBar, 4))
            return;
        if (QtMocHelpers::indexOfMethod<void (HardWork::*)(int )>(_a, &HardWork::filePrBarValue, 5))
            return;
        if (QtMocHelpers::indexOfMethod<void (HardWork::*)(int )>(_a, &HardWork::prBarValue, 6))
            return;
        if (QtMocHelpers::indexOfMethod<void (HardWork::*)(int )>(_a, &HardWork::wFilePrBarValue, 7))
            return;
        if (QtMocHelpers::indexOfMethod<void (HardWork::*)(int )>(_a, &HardWork::wPrBarValue, 8))
            return;
        if (QtMocHelpers::indexOfMethod<void (HardWork::*)(QString )>(_a, &HardWork::message, 9))
            return;
    }
}
...
// SIGNAL 6
void HardWork::prBarValue(int _t1)
{
...
// SIGNAL 8
void HardWork::wPrBarValue(int _t1)
{
